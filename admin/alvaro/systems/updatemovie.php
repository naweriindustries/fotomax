...
$initupdateproceedure=mysqli_query($benzima,"UPDATE movieslists SET moviename='$moviename',movieposterportrait='$imagesshda', moviepotraitlandscape='$imagesshdb',videolink='$imagesshd',movieprice='$price',moviepricingstatus='$freeorpaid',moviegenre='$genre',activity='$enableordisable' WHERE id='$movieids' ");
...

{
	...
	$movieeditsuccess="Movie Updated";
}

else{

	$movieediterror="Movie Not Updated";
}
