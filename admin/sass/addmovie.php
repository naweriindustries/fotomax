...
<body>
	...
	<?php
						 ...
						 if($movieaddsuccess){
							...
							echo'<div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;</em> '.$movieaddsuccess.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';

						} 

						elseif($movieadderror){

							echo'<div class="alert bg-danger" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em> '.$movieadderror.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';
						...
						?>
									...
									<form action="" method="POST" enctype="multipart/form-data">
										...
										<input required="true" type="file" class="form-control"  name="potrait">
										<br>
											<label>Poster Landscape </label>
											<input required="true" type="file" class="form-control"   name="landscape">
										<br>
										...
										<br>
											...
											<input required="true" type="text" class="form-control"   name="price">
										<br>
...
<label>Genre<small style="color:green"> (Select Cartegory) </small></label>
...

				{
					...
					?>
											...
											<option selected="true" value="<?php echo$bg;?>" class="form-control"><?php echo$altitle;?></option><br><br>
...
<br>
										...
										<input type="submit" class="btn btn-block btn-danger" value="Add Movie"  name="addmovie">
