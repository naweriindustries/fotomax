...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Add Genre
	...
	<?php
						 ...
						 if($instantdataaddsuccess){

							echo'<div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;</em> '.$instantdataaddsuccess.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';

						} 

						elseif($instantdataadderror){

							echo'<div class="alert bg-danger" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em> '.$instantdataadderror.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';
						...
						?>
									...
									<form action="" method="POST" enctype="multipart/form-data">
										...
										<input required="true" type="text" class="form-control"   name="maintitle">
...
<br>
										...
										<input type="submit" class="btn btn-block btn-danger" value="Save Changes"  name="addgenre">
