...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Edit Genre

					 <a href="genres.php"><button class="btn btn-success" style="float: right;"><i class="fa fa-arrow-left"></i></button></a>
	...
	<?php
						 ...
						 if($instantdataeditsuccess){

							echo'<div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;</em> '.$instantdataeditsuccess.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';

						} 

						elseif($instantdataediterror){

							echo'<div class="alert bg-danger" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em> '.$instantdataediterror.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';
						...
						?>
									...
									<form action="" method="POST" enctype="multipart/form-data">
										...
										<input required="true" type="text" class="form-control" value="<?php echo$genre;?>"   name="maintitle">
										...
										<?php } elseif($genrestatus=='disable') {?> 

												<option value="enable" class="form-control">Enable</option><br>
											<option value="disable"  selected="true" class="form-control">Disable</option>
...
<br>
										...
										<input type="submit" class="btn btn-block btn-danger" value="Save Changes"  name="updategenre">
