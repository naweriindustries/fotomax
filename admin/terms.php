		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Terms Searched By Users
...
<thead>
 ...
 <tbody id="myTable">
						...
						<?php $getinstantaccessdata=mysqli_query($benzima,"SELECT * FROM  searchterms ORDER BY id DESC");
						     while($instantdata=mysqli_fetch_array($getinstantaccessdata))

				{

					$bg=htmlentities($instantdata['id']);
					$altitle=htmlentities($instantdata['keyword']);
