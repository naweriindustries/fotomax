		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"> All Movies

					 <a href="addmovie.php"><button class="btn btn-success" style="float: right;"><i class="fa fa-plus"></i></button></a>
...
<thead>
 ...
 <tbody id="myTable">
						...
						<?php $getinstantaccessdata=mysqli_query($benzima,"SELECT * FROM movieslists WHERE moviepricingstatus='paid' ORDER BY id DESC LIMIT 24");
