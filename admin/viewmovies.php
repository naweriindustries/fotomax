		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">View Movies
					...
					<div class="panel-body">
									...
									<video src="../sample movies/<?php echo$video;?>" poster="<?php echo$landscape;?>" controls="controls" loop style="border-radius:0.5%; height: 500px; width:100%;"></video>
