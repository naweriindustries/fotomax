		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Genres

					 <a href="addgenre.php"><button class="btn btn-success" style="float: right;"><i class="fa fa-plus"></i></button></a>
...
<thead>
 ...
 <tbody id="myTable">
						...
						<?php $getinstantaccessdata=mysqli_query($benzima,"SELECT * FROM genres");
...

				{
					...
					$instantindex=htmlentities($instantdata['datecreated']);
					$insatntstatus=htmlentities($instantdata['status']);
...
<tr>
	...
	<td> <a target="_blank" href="edit-genre.php?instantid=<?php echo$bg;?>"><button class="btn btn-primary" style="text-align: center; /* Left-align text */"><i class="fa fa-pencil"></i></button></a></td>




	<?php if($statusinstant=='enable')  {

		?>
<td> <a   href="elements.php?disableinstant=<?php echo$instantindex;?>"><button class="btn btn-warning"  style="text-align: center; /* Left-align text */"><i class="fa fa-warning"></i></button></a></td>

		<?php
	}
	  elseif($statusinstant=='disable') {  ?> <td> <a  href="elements.php?enableinstant=<?php echo$instantindex;?>"><button class="btn btn-success"  style="text-align: center; /* Left-align text */"><i class="fa fa-check"></i></button></a></td>  <?php } ?>
	

	<td> <?php echo$insatntstatus;?> </td>
