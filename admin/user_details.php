...
<center>
		<img style="width:140px; height: 140px; border-radius: 100%;" src="../acproofs/<?php echo$photo;?>"  class="img-responsive">
...
<?php
if($updateactivitytastalert){

							echo'<div class="alert bg-danger" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em> '.$updateactivitytastalert.'<a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>';
...
<b> Logged In : </b> <?php echo$uloginstat;?>
<br>
<br>
<b> A/C Age Status : </b> <?php echo$acageustat;?>
<br>
<br>

<b> Reg. Date : </b> <?php echo$regdates;?>
<br>
<br>
