(function() {
    ...
    componentHandler = (function() {
        ...
        function upgradeElementInternal(element, optJsClass) {
            ...
            var upgradingEv = createEvent_('mtn-componentupgrading', true, true);
            ...
            for (var i = 0, n = classesToUpgrade.length, registeredClass; i < n; i++) {
                ...
                var upgradedEv = createEvent_('mtn-componentupgraded', true, false);
        ...
        function deconstructComponentInternal(component) {
            if (component) {
                ...
                var ev = createEvent_('mtn-componentdowngraded', true, false);
    ...
    window.addEventListener('load', function() {
         ...
         * tested, adds a mtn-js class to the <html> element. It then upgrades all MDL
         * components requiring JavaScript.
         */
        if ('classList' in document.createElement('div') && 'querySelector' in document && 'addEventListener' in window && Array.prototype.forEach) {
            document.documentElement.classList.add('mtn-js');
